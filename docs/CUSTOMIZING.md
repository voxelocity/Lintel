...
| `acrylic` / `acrylicTint` | Blur the desktop behind the bar + tint over it (lower the tint alpha for clearer glass) |
| `aeroBlur` | Use the clearer classic Aero "liquid glass" blur instead of frosted acrylic |
